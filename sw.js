const CACHE = 'min-works-v85-plus-photo-state';
const ASSETS = ['./mobile-controls.js?v=66',
  './', './device-session.js?v=63', './mobile-update.css?v=66', './plus-icon-design-180.png', './plus-icon-design-192.png', './plus-icon-design-512.png', './plus-icon-design-maskable-512.png', './index.html?v=plus69', './app-latest.css?v=53', './ui-foundation.css?v=57', './ui-modern.css?v=57', './ui-linear.css?v=57',
